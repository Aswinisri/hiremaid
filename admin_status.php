  ...
  color: white;
   ...
   <body>
    ...
    font-size: 16px;text-align: center;" width="100%">
        ...
        $sql = "SELECT * FROM tblmaidbooking where user_id=$id";
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                if ($status == 'pending' || $status == 'Cancelled') {
                    ...
                    echo '<td><a href="javascript:void(0)" class="btn  btn-sm btn-primary float-right buy_now" data-img="//www.tutsmake.com/wp-content/uploads/2019/03/jhgjhgjg.jpg"  data-amount="'.$Amount.'" data-id="1"><button class="button-10" role="button " onclick="listview()">Make Payment</button></a></td>';
