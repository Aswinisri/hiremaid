...
@media (max-width:450px){
   ...
   .bookings .box-container{
    ...
    <h1 style="font-size: 1.5rem;margin-top: 56px;
    margin-left: 578px;">Maid Details</h1>
<?php
...
while ($row = $res->fetch_assoc()) {
  ...
  <div class="card" style="margin: 192px 309px;">
   ...
   <p>ID Proof:<img src="admin/idproofimages/' . (isset($row["IdProof"]) ? $row["IdProof"] : '') . '" height="50px;" ></p>
                <p style="margin-top: -174px;    font-size: 16px;"> Name:' . (isset($row['Name'])? $row['Name'] : '') . '</p> 
...
if ($res->num_rows === 0) {
  echo '<center style="font-size: large;margin-top: 130px;">No maid details found for the specified criteria!!</center>';
}
